    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex-1 flex flex-col lg:ml-64">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-4 sm:px-6 py-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Crop Trends & Patterns</h1>
            ...
            <div class="flex-1 overflow-y-auto p-4 sm:p-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 sm:p-8 text-center">
                    <div class="max-w-md mx-auto">
                        ...
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 mb-2">Crop Trends & Patterns</h3>
                        <p class="text-sm text-gray-600">This page is under construction. Crop analysis features will be added here.</p>
                    </div>
                </div>
            </div>
        </div>
